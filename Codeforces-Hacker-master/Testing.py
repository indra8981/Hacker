...
language={'PascalABC.NET':'PascalABC.NET2','GNU C++':'GNU G++ 5.1.0','GNU C++14':'GNU G++14 6.4.0','GNU C++11':'GNU G++11 5.1.0','GNU C11':'GNU GCC C11 5.1.0','GNU C++17':'GNU G++17 7.3.0','Java 8':'Java 1.8.0_131','GNU C':'GNU GCC 5.1.0','Python 2':'Python 2.7','Python 3':'Python 3.6','MS C++':'Microsoft Visual C++ 2010','JavaScript':'JavaScript V8 4.8.0','PyPy 3':'PyPy 3.5.3 (5.10.0)','PyPy 2':'PyPy 2.7.13 (5.9.0)','GNU C++17 Diagnostics':'GNU C++17 Diagnostics (DrMemory)','Clang++17 Diagnostics':'Clang++17 Diagnostics'}
...
def custom_invoc(id,custom_code, lang, driver):
    ...
    testing_url = "http://codeforces.com/contest/1051/customtest"
    input = "2\n0 0\n1 3"
    desired_output = "2"
    ...
    for s in desired_output:
        ...
        i+=1
    if(b==0):
        print(language[lang]+" Hack id:!! " +id)
