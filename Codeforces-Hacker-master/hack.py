...
def login():
    ...
    search_field = driver.find_element_by_id("handleOrEmail")
    search_field.send_keys("plzmailindra")
    search_field = driver.find_element_by_id("password")
    search_field.send_keys("8981808220")
...
def startHacking(max_pages):
    ...
    while page <= max_pages:
        url = "http://codeforces.com/contest/1051/status/C/page/" + str(page) + "?order=BY_ARRIVED_DESC"
